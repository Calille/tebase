    ...
    initialNotes || [
      {
        id: "1",
        content:
          "Customer inquired about premium plan options. Sent follow-up email with pricing details.",
      ...
      },
      {
        id: "2",
        content:
          "Discussed implementation timeline. Customer needs solution by end of quarter.",
      ...
      },
      {
        id: "3",
        content:
          "Initial discovery call completed. Customer has 50+ users that need access.",
