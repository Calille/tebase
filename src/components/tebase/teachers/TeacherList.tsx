...
const TeacherList = ({
  ...
  const [teachingMethodFilter, setTeachingMethodFilter] = useState<string>("all");
  ...
  useEffect(() => {
    const fetchTeachers = async () => {
      if (initialTeachers) {
        // If teachers are provided as props, use them
  ...
  const filteredTeachers = teachers.filter((teacher) => {
    ...
    const matchesRegion =
      regionFilter === "all" ||
      (teacher.region && teacher.region === regionFilter);
      
    const matchesCertification =
      certificationFilter === "all" ||
      (teacher.certifications && 
       teacher.certifications.includes(certificationFilter));
    ...
    const matchesTeachingMethod =
      teachingMethodFilter === "all" ||
      (teacher.teachingMethods && 
       teacher.teachingMethods.includes(teachingMethodFilter));

    return matchesSearch && matchesStatus && matchesAvailability && 
           matchesRegion && matchesCertification && matchesLanguage && matchesTeachingMethod;
  });
      ...
      <div className="p-4 border-b">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
          ...
          <div className="flex gap-2">
            <Link to="/tebase/teachers/analytics">
              <Button
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="Gloucestershire">Gloucestershire</SelectItem>
                ...
                <SelectItem value="Leicestershire">Leicestershire</SelectItem>
                <SelectItem value="Lincolnshire">Lincolnshire</SelectItem>
                <SelectItem value="Merseyside">Merseyside</SelectItem>
                <SelectItem value="Norfolk">Norfolk</SelectItem>
                <SelectItem value="Northamptonshire">Northamptonshire</SelectItem>
                <SelectItem value="Northumberland">Northumberland</SelectItem>
                <SelectItem value="Nottinghamshire">Nottinghamshire</SelectItem>
                ...
                <SelectItem value="Staffordshire">Staffordshire</SelectItem>
                <SelectItem value="Suffolk">Suffolk</SelectItem>
                <SelectItem value="Surrey">Surrey</SelectItem>
                <SelectItem value="Sussex">Sussex</SelectItem>
                <SelectItem value="Warwickshire">Warwickshire</SelectItem>
            ...
            <Select
              ...
              onValueChange={(value) => setCertificationFilter(value)}
            >
              <SelectTrigger className="w-[150px]">
                <div className="flex items-center gap-2">
            ...
            <Select
              value={teachingMethodFilter}
              onValueChange={(value) => setTeachingMethodFilter(value)}
            >
              ...
              <SelectContent>
                <SelectItem value="all">All Teaching Methods</SelectItem>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          handleToggleFavorite(teacher.id, teacher.favorite);
                        }}
